...
// **********************************************************************************
// **                                                                              **
// ** loginimpressum.php                            (c) Wolfram Plettscher 05/2018 **
// **                                                                              **
// **********************************************************************************
...
<body>
	<div id="wrapper">
		...
		<li class='active'><a href='<?php echo checksslproxy ('loginimpressum.php')?>'><span>Impressum</span></a></li> 
            </ul>
        </div>
...
<table>
    ...
    <tr>
    	...
    	<th colspan="3">
			<img src="img/captcha_wp.png" width="300">
        </th>
    </tr><tr>
    	<td valign="top">
        ...
        <br/><br/>
        <i>Quelle:  </i><a href="http://www.muster-vorlagen.net" target="_blank">muster-vorlagen.net</a><br/><br/>
        </td><td>
        </td><td valign="top">
            ...
            <br/><br/>
            <i>Quelle: </i><a href="http://www.twigg.de/haftungsausschlussimpressumenglisch.htm" target="_blank">twigg.de</a><br/><br/>
