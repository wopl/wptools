<!-- ---------------------------------------------------------------------------- -->
<!--                                                                              -->
<!-- team4.php                                     (c) Wolfram Plettscher 01/2015 -->
<!--                                                                              -->
<!-- ---------------------------------------------------------------------------- -->
...
<form method='post'>
    <table>
    	<tr>
 		...
 		<td><h3>select View: </h3></td>
 		<td><input class='css_btn_class' name='team1' type='submit' value='Base View' formaction='index.php?section=team1' /></td>
  		<td><input class='css_btn_class' name='team2' type='submit' value='Contact View' formaction='index.php?section=team2' /></td>
		<td><input class='css_btn_class' name='team3' type='submit' value='Remarks View' formaction='index.php?section=team3' /></td>
...
if ($mygrouping == "1") {
	...
	echo "<h1>Project Team - DO NOT USE - under development</h1>";
